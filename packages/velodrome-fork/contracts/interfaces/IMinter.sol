...
import {IPhasor} from "./IPhasor.sol";
...
interface IMinter {
    ...
    /// @notice Interface of Phasor.sol
    function phasor() external view returns (IPhasor);
    ...
    /// @notice Starting weekly emission of 15M PHASOR (PHASOR has 18 decimals)
    ...
    ///         weekly * (ve.totalSupply / phasor.totalSupply) ^ 3 / 2
    ///         Note that ve.totalSupply is the locked ve supply
    ///         phasor.totalSupply is the total ve supply minted
    /// @param _minted Amount of PHASOR minted this epoch
