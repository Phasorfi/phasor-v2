...
export const ROUTER_ABI = [
  ...
  // Add Liquidity - includes stable param
  {
    inputs: [
  ...
  // Add Liquidity ETH - includes stable param
  {
    inputs: [
  ...
  // Remove Liquidity - includes stable param
  {
    inputs: [
      { internalType: "address", name: "tokenA", type: "address" },
      { internalType: "address", name: "tokenB", type: "address" },
  ...
  // Remove Liquidity ETH - includes stable param
  {
    inputs: [
      { internalType: "address", name: "token", type: "address" },
      { internalType: "bool", name: "stable", type: "bool" },
  ...
  // Swap - uses Route[] struct instead of address[] path
  {
    inputs: [
  ...
  // Swap ETH for Tokens - uses Route[] struct
  {
    inputs: [
      { internalType: "uint256", name: "amountOutMin", type: "uint256" },
      {
  ...
  // Swap Tokens for ETH - uses Route[] struct
  {
    inputs: [
      { internalType: "uint256", name: "amountIn", type: "uint256" },
      { internalType: "uint256", name: "amountOutMin", type: "uint256" },
  ...
  // Get Amounts Out - uses Route[] struct
  {
    inputs: [
      { internalType: "uint256", name: "amountIn", type: "uint256" },
      {
  ...
  // Get Reserves - includes stable and factory params
  {
    inputs: [
      { internalType: "address", name: "tokenA", type: "address" },
      { internalType: "address", name: "tokenB", type: "address" },
...
// Velodrome Pool Factory ABI
// Key difference from V2: getPool(tokenA, tokenB, stable) instead of getPair(tokenA, tokenB)
export const FACTORY_ABI = [
  // Get Pool - includes stable param
  {
    inputs: [
      { internalType: "address", name: "tokenA", type: "address" },
      { internalType: "address", name: "tokenB", type: "address" },
  ...
  // Create Pool - includes stable param
  {
    inputs: [
      { internalType: "address", name: "tokenA", type: "address" },
      { internalType: "address", name: "tokenB", type: "address" },
...
export const POOL_FACTORY_ABI = FACTORY_ABI;

// Velodrome Pool ABI (replaces UniswapV2Pair)
// Key difference from V2: stable() function and getReserves returns uint256 instead of uint112
export const PAIR_ABI = [
  ...
  // Velodrome uses uint256 for reserves (not uint112 like V2)
  {
    inputs: [],
    name: "getReserves",
    outputs: [
  ...
  // Stable pool indicator (new in Velodrome)
  {
    inputs: [],
    name: "stable",
    outputs: [{ internalType: "bool", name: "", type: "bool" }],
  ...
  // Metadata function (unique to Velodrome)
  {
    inputs: [],
    name: "metadata",
    outputs: [
...
// Alias for clarity - Pool = Pair in Velodrome terminology
